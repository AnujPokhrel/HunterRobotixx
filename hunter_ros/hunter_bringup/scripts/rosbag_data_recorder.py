...
class ListenRecordData:
    def __init__(self, save_data_path, rosbag_play_process):
        ...
        self.gyro_msgs = np.zeros((60, 3), dtype=np.float32)
        ...
        rospy.Subscriber('/imu', Imu, self.accel_callback) # 60hz
    ...
    #included the code in the accl_callback and commenting this out
